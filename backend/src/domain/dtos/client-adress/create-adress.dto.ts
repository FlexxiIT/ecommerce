...
export class CreateAddressDto {
    ...
    static create(object: { [key: string]: any }): [string?, CreateAddressDto?] {
        ...
        const { streetName, streetNumber, floor, apartment, locality, city, provinceCode, postalCode, clientId } = object;
        ...
        return [undefined, new CreateAddressDto(streetName, streetNumber, floor, apartment, locality, city, provinceCode, postalCode, clientId)];
